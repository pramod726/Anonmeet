...
const Navbar = () => {
  return (
    <nav className="bg-black p-4 flex justify-between items-center sticky top-0 z-50 border-b-[1px] border-grey-200">
      {/* Logo */}
      <Link to="/">
      <div className="flex items-center mx-8">
        ...
        <span className="text-white text-lg font-semibold">Anonmeet</span>
      </div>
      </Link>
